  ...
  function handleUpdate(event) {
    ...
    function projektiTC() {
       // hideGreska();     
        ...
        let aktivni_=document.getElementById(aktivni);
    ...
    <Navbar color="light" light expand="md">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="btn-group" role="group">
            ...
            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
              <a href={undefined} class="dropdown-item" onclick="urediOsobuOtvori()">Uredi osobu</a>
              <a href={undefined} class="dropdown-item" onclick="urediPodugovaraca()">Uredi podugovarača</a>
            </div>
          </div>
        ...
        <div id="pretrazi" class="pretrazi">
          <button type="button" onclick="pretrazi()" class="input-group-text">
            <Search />
          </button>
        </div>
        <div id="trazi" class="form-inline my-2 my-lg-0" style="display: none">
          <input type="text" id="projektTrazi" onKeyUp="onProjektTrazi()" class="form-control mr-sm-2">
